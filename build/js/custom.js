...
$(document).ready(function() {
    ...
    var setContentHeight = function () {
        ...
        var bodyHeight = $BODY.outerHeight(),
            footerHeight = $BODY.hasClass('footer_fixed') ? 20 : $FOOTER.height(),
            leftColHeight = $LEFT_COL.eq(1).height() + $SIDEBAR_FOOTER.height(),
            contentHeight = bodyHeight < leftColHeight ? leftColHeight : bodyHeight;

        // normalize content
        contentHeight -= $NAV_MENU.height() + footerHeight + 44;
...
// CHENGED JQUERY TO ONLY SELECT ALL FOR THE THE TABLE YOU SELECTED IT FOR  ## JACQUES ## 18/01/2017
...
//Format a number in JS to decimal places and optional ',' for currency
