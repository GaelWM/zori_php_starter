...
class Settings extends ZoriList
{
   private $ID = 0;
   ...
   {
      $this->ListSQL("
         SELECT sysSettings.SettingID, sysSettings.strSetting as 'Setting', sysSettings.strValue as 'Value'
         , sysSettings.strComment as 'Comment', sysSettings.strLastUser as 'Last User', sysSettings.dtLastEdit as 'Last Edit'
         FROM sysSettings
         GROUP BY sysSettings.strSetting,sysSettings.strValue,sysSettings.strLastUser,sysSettings.dtLastEdit
   ...
   {
      $db = new ZoriDatabase("sysSettings", $SettingID, null, 0);
