...
class SecurityGroup extends ZoriList
{
   private $ID = 0;
   ...
   {
      $this->ListSQL("
         SELECT sysSecurityGroup.SecurityGroupID,sysSecurityGroup.strSecurityGroup as 'Security Group'
         ,sysSecurityGroup.blnActive as 'Active',sysSecurityGroup.strLastUser as 'Last User'
         ,sysSecurityGroup.dtLastEdit as 'Last Edit'
         FROM sysSecurityGroup
         GROUP BY sysSecurityGroup.strSecurityGroup,sysSecurityGroup.blnActive,sysSecurityGroup.strLastUser
         ,sysSecurityGroup.dtLastEdit
         ORDER BY sysSecurityGroup.strSecurityGroup",0,"","Edit");
      return $this->renderTable("User Group List");
   }

   public static function getSecurityEntities($SecurityGroupID)
   {
      global $xdb;
      ...
      return "
            <table cellspacing='1' cellpadding='2' border='0' width='100%' class='table table-sm table-hover table-responsive'>
   ...
   public static function Save(&$SecurityGroupID)
   {
      ...
      $db = new ZoriDatabase("sysSecurityGroup", $SecurityGroupID, null, 0);
      ...
      foreach($strNotes as $key => $value)
      {
          ...
          */
         $sysMenuLevel2db = new ZoriDatabase("sysMenuLevel2", $key, null, 0);
          ...
          */
         $sysSecuritydb = new ZoriDatabase("sysSecurity", 0, null, 0);
