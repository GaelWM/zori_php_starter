<?php
/**
* 20170618: footer vendors includes -- Gael
*/
...
echo " 
      ...
      <script type='text/javascript' src='../vendors/DateJS/build/date-en-US.js'></script>
      ...
      <!-- Input Mask bundle -->
      <script type='text/javascript' src='../vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js'></script>
      ...
      <script type='text/javascript' src='../vendors/gauge.js/assets/prettify.js'></script>

      <!-- Form Validation -->
      <script src='../vendors/validator/validator.js'></script>

      <!-- Custom Theme Scripts  ALWAYS LAST -->
