...
--
-- Host: localhost:3306
-- Generation Time: Jun 24, 2017 at 05:31 PM
...
(256, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-11 22:57:30'),
(257, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-11 22:59:06'),
(258, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-12 17:24:51'),
(259, '', '::1', 'Login failed: Incorrect password', 'pj@overdrive.co.za', 'test', '2016-10-12 18:12:14'),
(260, '', '::1', 'Login failed: Incorrect password', 'pj@overdrive.co.za', 'test', '2016-10-12 18:12:21'),
(261, '', '::1', 'Login failed: Incorrect password', 'pj@overdrive.co.za', 'test', '2016-10-12 18:12:32'),
(262, '', '::1', 'Login successful', 'pj@overdrive.co.za', 'test', '2016-10-12 18:13:52'),
(263, '', '::1', 'Login successful', 'pj@overdrive.co.za', 'test', '2016-10-12 18:14:44'),
(264, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-12 19:01:04'),
(265, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-12 19:53:38'),
(266, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-12 20:02:07'),
(267, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-15 10:42:14'),
(268, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-15 10:42:32'),
(269, '', '::1', 'Login failed: User not found or SG not active', '', '', '2016-10-16 20:33:25'),
(270, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-16 20:37:26'),
(271, '', '::1', 'Login failed: User not found or SG not active', '', '', '2016-10-16 20:40:01'),
(272, '', '::1', 'Login failed: User not found or SG not active', '', '', '2016-10-16 20:40:14'),
(273, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-16 23:27:37'),
(274, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-18 20:53:29'),
(275, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-22 17:43:07'),
(276, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-22 21:07:13'),
(277, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-23 09:54:31'),
(278, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-28 00:10:14'),
(279, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-10-30 02:35:30'),
(280, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-11 23:52:27'),
(281, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-12 10:51:37'),
(282, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-12 10:55:54'),
(283, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-13 23:24:39'),
(284, '', '::1', 'Login successful', 'pj@overdrive.co.za', 'test', '2016-11-14 22:09:16'),
(285, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-16 23:16:04'),
(286, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-11-18 22:48:49'),
(287, '', '::1', 'Login successful', 'pj@overdrive.co.za', 'test', '2016-11-23 00:25:18'),
(288, '', '127.0.0.1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-03 11:57:38'),
(289, '', '127.0.0.1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-03 19:14:09'),
(290, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-05 20:20:38'),
(291, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-08 20:42:59'),
(292, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-15 17:08:15'),
(293, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2016-12-17 22:48:43'),
(294, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-01-07 22:56:00'),
(295, '', '::1', 'Login failed: User not found or SG not active', 'admin', 'admin2016', '2017-01-17 23:26:24'),
(296, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-01-17 23:26:36'),
(297, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-03-20 23:08:46'),
(298, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-03-20 23:13:16'),
(299, '', '::1', 'Login failed: Incorrect password', 'gael@overdrive.co.za', 'gael04', '2017-06-16 11:42:43'),
(300, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-16 11:46:19'),
(301, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-18 01:34:12'),
(302, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-18 02:22:58'),
(303, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-24 14:21:07'),
(304, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-24 14:21:29'),
(305, '', '::1', 'Login successful', 'gael@overdrive.co.za', 'test', '2017-06-24 15:11:32');
...
CREATE TABLE `sysmenulevel1` (
  ...
  `EN_strMenuLevel1` varchar(100) DEFAULT NULL,
  `AF_strMenuLevel1` varchar(100) DEFAULT NULL,
  `FR_strMenuLevel2` varchar(100) DEFAULT NULL,
  `strUrl` varchar(100) NOT NULL DEFAULT '#',
  `intOrder` int(11) NOT NULL DEFAULT '0',
  `strIconClass` varchar(50) NOT NULL,
  `blnActive` tinyint(1) NOT NULL DEFAULT '1',
  `strLastUser` varchar(100) NOT NULL,
  `dtLastEdit` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sysmenulevel1` (`MenuLevel1ID`, `strMenuLevel1`, `EN_strMenuLevel1`, `AF_strMenuLevel1`, `FR_strMenuLevel2`, `strUrl`, `intOrder`, `strIconClass`, `blnActive`, `strLastUser`, `dtLastEdit`) VALUES
(1, 'Home', 'Home', 'Tuis', 'Acceuil', 'index.php', 0, 'fa fa-home', 1, 'SYSTEM', '2017-06-18 10:54:13'),
(2, 'System Settings', NULL, NULL, NULL, '#', 9, 'fa fa-gear', 1, '', '2017-06-18 10:54:13'),
(3, 'Administration', NULL, NULL, NULL, '#', 8, 'fa fa-cloud', 1, '', '2017-06-18 10:54:13'),
(4, 'Reports', NULL, NULL, NULL, 'report.php', 3, 'fa fa-bar-chart', 1, '', '2017-06-18 10:54:13'),
(9, 'My Profile', NULL, NULL, NULL, 'my.profile.php', 10, 'fa fa-clone', 1, '', '2017-06-18 10:54:13'),
(10, 'Music', NULL, NULL, NULL, 'music.php', 3, 'fa fa-music', 1, '', '2017-06-18 10:54:13');
...
(68, 3, 'Usage Logs', 'UsageLog', 'usage.log.php', '', 4, 1, 0),
(69, 10, 'Music', 'Music', 'music.php', '', 1, 1, 0);
...
(1, 'Admin Dev', 1, 'Gael Wamba', '2016-11-18 22:52:21'),
(2, 'Admin', 1, 'PJ', '2012-03-19 14:33:04'),
(3, 'Zori Admin', 1, 'Gael Wamba', '2016-12-03 18:51:11');
...
(6, 'SMTP BCC', 'jacques@overdrive.co.za', 'BCC', 'PJ', '2015-02-09 15:13:01'),
...
(15, 'Brand', 'Zori Starter', 'MOVED To _nemo.translations.inc.php', 'Gael', '2016-10-14 00:09:42'),
...
(64, 'AF_Title', 'Company Name', '', 'wamba', '2016-04-19 10:29:05'),
...
(71, 'View SYSFAQ_English', 'CREATE OR REPLACE VIEW vieFAQ_EN AS SELECT lstTopic,strTitle, strTags, txtFAQ ,blnActive FROM sysfaq;', NULL, 'SYSTEM', '2016-11-14 22:21:58'),
(72, 'View SysFAQ Afrikaans', 'CREATE OR REPLACE VIEW vieFAQ_AF AS SELECT lstTopic,strTitle, strTags, txtFAQ ,blnActive FROM sysfaq;', NULL, 'SYSTEM', '2016-11-14 22:21:58'),
(73, 'View SysFAQ French', 'CREATE OR REPLACE VIEW vieFAQ_FR AS SELECT lstTopic,strTitle, strTags, txtFAQ, blnActive FROM sysfaq;', NULL, 'SYSTEM', '2016-11-14 22:21:58');
...
(-4, 1, 'Jacques', 'jacques@overdrive.co.za', '9PH79P', NULL, 'blank.jpg', 'English', NULL, '0000-00-00 00:00:00', 1, 'SYSTEM', '2016-01-12 09:24:29'),
(-3, 1, 'Gareth', 'gareth@overdrive.co.za', 'a681aec86b6823bb3ce08c1e90ae3345', NULL, 'blank.jpg', 'English', 'PJ', '2010-12-07 12:56:33', 1, 'PJ', '2014-12-17 15:30:10'),
(-2, 1, 'Software', 'software@overdrive.co.za', 'cff3e99c29f38e82649a6b058985ea5c', '', 'blank.jpg', 'English', 'PJ', '2010-12-07 12:56:33', 1, 'PJ', '2016-01-11 13:39:48'),
(-1, 1, 'Pieter van der Merwe', 'pj@overdrive.co.za', '098f6bcd4621d373cade4e832627b4f6', '', '000-1_Desertsd.jpg', 'English', 'PJ', '2010-12-07 12:56:33', 1, 'Pieter van der Merwe', '2016-10-12 18:13:36'),
(1, 1, 'Gael Wamba', 'gael@overdrive.co.za', '098f6bcd4621d373cade4e832627b4f6', '0797134913', '00001_IMG_0042.jpg', 'English', 'Gael', '2016-03-31 09:35:12', 1, 'Gael Wamba', '2016-12-04 13:25:25'),
(2, 1, 'Neil', 'neils@overdrive.co.za', 'd41d8cd98f00b204e9800998ecf8427e', '', '', 'English', 'Neil', '2016-05-03 10:52:33', 0, 'Gael', '2016-11-12 11:01:05'),
(3, 1, 'De Monaco', 'demonaco@gmail.com', '8fc8cc0567ecd46b6b74367f7a4931b4', '0797134913', '00003_IMG_0032.JPG', 'English', 'Gael Wamba', '2016-10-13 01:31:54', 0, 'Gael Wamba', '2016-11-14 19:57:45'),
(4, 1, 'Norby', 'norby@gmailo.com', 'd41d8cd98f00b204e9800998ecf8427e', '02133157956', '00004_IMG_0042.jpg', 'English', 'Gael Wamba', '2016-12-08 22:25:42', 1, 'Gael Wamba', '2016-12-08 21:26:14');
...
(1, 'Zori Template', 'Zori: Welcome', 'Hi [ClientName],\r\n\r\nWelcome to the Zori Framework.\r\n\r\nWe are intent to provide the best quality of our products to our users \r\n[ReadOnline][Logo][ReadReceipt]', '', '', '', 1, 'Gael Wamba', '2016-12-03 18:32:52');
...
--
-- Stand-in structure for view `viefaq_af`
-- (See below for the actual view)
--
CREATE TABLE `viefaq_af` (
`lstTopic` varchar(100)
...
--
-- Stand-in structure for view `viefaq_en`
-- (See below for the actual view)
--
CREATE TABLE `viefaq_en` (
`lstTopic` varchar(100)
,`strTitle` varchar(100)
,`strTags` varchar(100)
,`txtFAQ` text
...
--
-- Stand-in structure for view `viefaq_fr`
-- (See below for the actual view)
--
CREATE TABLE `viefaq_fr` (
`lstTopic` varchar(100)
,`strTitle` varchar(100)
,`strTags` varchar(100)
,`txtFAQ` text
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vieemailcontacts`  AS  select distinct `tblemail`.`strTo` AS `ViewID`,`tblemail`.`strTo` AS `strView`,'' AS `DisplayName` from `tblemail` where ((not((`tblemail`.`strTo` like '%;%'))) and (`tblemail`.`strTo` <> '')) order by `ViewID`,`strView` ;

-- --------------------------------------------------------

--
-- Structure for view `viefaq_af`
--
DROP TABLE IF EXISTS `viefaq_af`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viefaq_af`  AS  select `sysfaq`.`lstTopic` AS `lstTopic`,`sysfaq`.`strTitle` AS `strTitle`,`sysfaq`.`strTags` AS `strTags`,`sysfaq`.`txtFAQ` AS `txtFAQ`,`sysfaq`.`blnActive` AS `blnActive` from `sysfaq` ;

-- --------------------------------------------------------

--
-- Structure for view `viefaq_en`
--
DROP TABLE IF EXISTS `viefaq_en`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viefaq_en`  AS  select `sysfaq`.`lstTopic` AS `lstTopic`,`sysfaq`.`strTitle` AS `strTitle`,`sysfaq`.`strTags` AS `strTags`,`sysfaq`.`txtFAQ` AS `txtFAQ`,`sysfaq`.`blnActive` AS `blnActive` from `sysfaq` ;

-- --------------------------------------------------------

--
-- Structure for view `viefaq_fr`
--
DROP TABLE IF EXISTS `viefaq_fr`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `viefaq_fr`  AS  select `sysfaq`.`lstTopic` AS `lstTopic`,`sysfaq`.`strTitle` AS `strTitle`,`sysfaq`.`strTags` AS `strTags`,`sysfaq`.`txtFAQ` AS `txtFAQ`,`sysfaq`.`blnActive` AS `blnActive` from `sysfaq` ;
...
--
ALTER TABLE `syslogin`
  MODIFY `LoginID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=306;
--
-- AUTO_INCREMENT for table `sysmenulevel1`
--
ALTER TABLE `sysmenulevel1`
  MODIFY `MenuLevel1ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `sysmenulevel2`
--
ALTER TABLE `sysmenulevel2`
  MODIFY `MenuLevel2ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=70;
--
...
--
ALTER TABLE `syssecuritygroup`
  MODIFY `SecurityGroupID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `syssettings`
--
ALTER TABLE `syssettings`
  MODIFY `SettingID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
...
--
ALTER TABLE `tblemailtemplate`
  MODIFY `EmailTemplateID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
