<?php
   ...
   $BR = "<br />";
   $DT = date("Y-m-d H:i"); // cureent date hour
...
//******************************
   ...
   {
      $sdb = new ZoriDatabase("sysSpam", 0, null, 0);
