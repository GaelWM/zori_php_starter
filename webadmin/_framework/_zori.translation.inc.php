...
global $_TRANSLATION, $_LANGUAGE, $SystemSettings;
...
//20160111 - disable muli language - pj
if($SystemSettings[blnMultiLanguage] == 0)
{ 
   unset($_LANGUAGE); 
}
...
# globals / system
$_TRANSLATION["EN"]["Brand"] = $SystemSettings[EN_Brand];
$_TRANSLATION["AF"]["Brand"] = $SystemSettings[AF_Brand];

$_TRANSLATION["EN"]["Title"] = $SystemSettings[EN_Title];
$_TRANSLATION["AF"]["Title"] = $SystemSettings[AF_Title];
...
//form fields:
   ...
   $_TRANSLATION["EN"]["dtLastEdit"] = "Laaste Edit";
